...
const REGULATIONS = [
  {
    ...
    description: 'Layanan Pinjam Meminjam Uang Berbasis Teknologi',
    score: 94,
    status: 'compliant',
  },
  {
    ...
    description: 'Inovasi Keuangan Digital di Sektor Jasa Keuangan',
    score: 88,
    status: 'compliant',
  },
  {
    id: 3,
    code: 'SLIK Reporting',
    description: 'Sistem Layanan Informasi Keuangan',
    score: 72,
    status: 'warning',
  },
  {
    id: 4,
    code: 'BI Regulation',
    description: 'Peraturan Bank Indonesia tentang Pembayaran Digital',
    score: 91,
    status: 'compliant',
  },
  {
    ...
    description: 'Transparansi dan Publikasi Laporan Keuangan',
    score: 45,
  ...
  },
  {
    id: 6,
    code: 'e-KYC Standard',
    description: 'Know Your Customer Elektronik',
    score: 96,
    status: 'compliant',
  },
]
...
export default function OJKStatus() {
  ...
  const overallRate = Math.round(REGULATIONS.reduce((s, r) => s + r.score, 0) / total)
